...
บรรทัดที่ 10-12 : ถ้า hour หรือ minute น้อยกว่า 0 ให้พิมพ์ "please enter a non negative number"
บรรทัดที่ 13 : ถ้าไม่ใช่ให้ทำบรรทัดที่ 15-19
บรรทัดที่ 14-16 : ถ้า minute มากกว่า 0 ให้เพิ่ม hour ขึ้น 1
บรรทัดที่ 17 : สร้างตัวแปรชื่อ fee และกำหนดค่าเท่ากับ (hour - 1)*30
บรรทัดที่ 18 : พิมพ์ค่า fee ออกมา
*/
...
Line 10-12 : If hour or minute is less than 0, print "please enter a non negative number".
Line 13 : Else, follow line 15-19.
Line 14-16 : If minute is greater than 0, add the value of hour by 1.
Line 17 : Create a variable named fee and set a value equal to (hour - 1)*30.
Line 18 : Print fee.
*/